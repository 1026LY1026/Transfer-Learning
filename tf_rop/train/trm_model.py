...
class TransAm(nn.Module):
    def __init__(self, feature_size, out_size, d_model=256, num_layers=2, dropout=0.25):  # 0.25
        super(TransAm, self).__init__()
        self.feature_size = feature_size
        self.model_type = 'Transformer'
        self.src_mask = None
        self.embedding = nn.Linear(feature_size, 256)
    ...
    #def forward(self, src, src_padding, tgt):
