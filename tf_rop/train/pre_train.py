...
test_loader, test_feature_size, test_out_size = test_data.dataset(seq_len,data_path_bz_1) #15
...
def initiate():
    ...
    for epoch in range(2000):
        ...
        loss_acc_mse_mae.to_csv('./output/bz/new_bz/loss_acc_mse_mae_retrain.csv', sep=",", index=True)

        torch.save(model.state_dict(), './output/bz/new_bz/Model_bz10_retrain.pkl')
